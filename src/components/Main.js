      ...
      <div className='main'>
          <img src='../../pictures/mainPagePicture.svg' className='main-image'></img>
            <div className='main-text'>
                ...
                <div>
                  <button className='btn-main' onClick={event =>  window.location.href='/fal'}>فال حافظ</button>
                  <button className='btn-main' onClick={event =>  window.location.href='/ganjine'}>گنجینه اشعار</button>
                </div>
            </div> 
            <div>
